...
class Books_Database:
    ...
    def collect_entries_Publication(self):
        ...
        list_author_var = {'publication name': publication_name, 'publication address': publication_address,
                         'publication accuracy': publication_accuracy}
        list_with_values = []
        for item in list_publilcation_var:
            if list_publilcation_var[item]:
                list_with_values.append([item, list_publilcation_var[item]])
    ...
    def event_book_button(self):
        ...
        result=[]
        result=firebase_access.handle_gui_requests(str,list_book)
        for item in result:
            print item
    ...
    def event_author_button(self):
        ...
        result = []
        result = firebase_access.handle_gui_requests(str, list_author)
        for item in result:
            print item
    ...
    def event_publication_button(self):
        ...
        result = []
        result = firebase_access.handle_gui_requests(str, list_publication)
        for item in result:
            print item
